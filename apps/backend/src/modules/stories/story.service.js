 ...
 *
 * Responsibility:
 * Processes operations for customer stories, enforcing row-based sorting
 * and UI positioning logic.
 *
 * Called By:
 * src/modules/stories/story.controller.js
 *
 * Depends On:
...
/**
 * Incrementally move a single story 'up' or 'down' the list within its row.
 */
...
/**
 * Re-indexes all story orderNumbers sequentially (1, 2, 3...) per row
 * to repair gaps left by deleted stories.
 */
