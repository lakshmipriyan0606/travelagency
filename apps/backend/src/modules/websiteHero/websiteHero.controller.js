...
export const createHero = async (req, res) => {
  try {
    ...
    return res.status(status).json({ message: error.message || "Failed to create hero", error: error.message });
  }
};
...
export const updateHero = async (req, res) => {
  try {
    ...
    const status = error.statusCode || 500;
    return res.status(status).json({ message: error.message || "Failed to update hero", error: error.message });
  }
};
...
export const deleteHero = async (req, res) => {
  try {
    ...
    const status = error.statusCode || 500;
    return res.status(status).json({ message: error.message || "Failed to delete hero", error: error.message });
  }
};
