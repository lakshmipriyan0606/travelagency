...
export default function LoginPage() {
    ...
    const { mutate, isPending } = useMutationAPIQuery(loginAPI, {
        onSuccess(data) {
            ...
            router.push('/admin/dashboard'); // Note: The Next.js migration plan uses /admin/dashboard or /admin/adminpanel? 
            // In the file tree, we saw `E:\project\travelagency\apps\web-next\src\app\admin\dashboard\page.tsx`, so we should route to /admin/dashboard
        },
    });
