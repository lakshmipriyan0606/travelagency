...
export const QUOTE_STATUS_META: Readonly<Record<QuoteStatus, QuoteStatusMeta>> = {
  ...
  [QuoteStatus.UNDER_REVIEW]: {
    label: 'Under Review',
    description: 'Our operations team is reviewing your travel requirements.',
    colorClass: 'text-violet-400 bg-violet-950 border-violet-800',
    iconName: 'Search',
    estimatedHours: 8,
  },
  ...
  [QuoteStatus.REVISION_REQUESTED]: {
    ...
    description: 'You have requested changes. Our team is updating the quote.',
    colorClass: 'text-yellow-400 bg-yellow-950 border-yellow-800',
    iconName: 'RotateCcw',
    estimatedHours: 8,
  },
