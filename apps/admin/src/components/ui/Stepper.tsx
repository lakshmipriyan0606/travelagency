/**
 * Stepper — polished admin progress stepper (dark + gold).
 * Mirrors B2B QuoteWizard / Register stepper patterns.
 */
"use client";
...
export default function Stepper({
  ...
  return (
    <div className="w-full">
      {/* Mobile */}
      <div className="lg:hidden flex items-center justify-between p-4 admin-surface-elevated rounded-2xl mb-1">
                ...
                <div className="flex flex-col text-left min-w-0">
                  <span
                    className={cn(
                      ...
                      isActive ? "text-[#F8B400]" : "text-white/35"
                    )}
                  >
                    Step {step.id}
                  </span>
