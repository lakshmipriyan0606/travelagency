    ...
    return (
        <section className="min-h-screen main__container_space">
            <div className='container mx-auto px-4 py-4'>
                ...
                <p className="mt-6 font-roboto text-[14px] sm:text-[16px] lg:text-lg"> <span className="text-4xl ">We</span> believe <span className="text-primary">every journey should be more than just travel</span> —it should be a story you cherish forever. Based on trust, care, and expertise, we design travel experiences that blend comfort, adventure, and culture. Whether it’s exploring vibrant cities, relaxing getaways, or customized holiday plans, we make sure your trip is seamless and memorable. With dedicated service and carefully curated packages, Sastikaa Travels is your trusted partner for discovering the world in a way that feels personal and unique.</p>
