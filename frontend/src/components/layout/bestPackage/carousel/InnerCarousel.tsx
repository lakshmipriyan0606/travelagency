    ...
    return (
        <div className="relative">
            <div>
                ...
                <div className="bottom-2 left-0 right-0 h-12 bg-gradient-to-r from-[#C59435] via-[#F3E79B] to-[#C59435] border-y border-[#D8C27A] flex items-center justify-center shadow-md">
