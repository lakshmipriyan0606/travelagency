...
const Navbar = () => {
  ...
  useMotionValueEvent(scrollY, "change", (latest) => {
    ...
    // Determine hide/show based on direction
  ...
  return (
    <>
      ...
      >
        ...
        {/* Mobile Menu */}
        <div
          className={`navbar-list mobile absolute top-full left-0 w-full bg-white shadow-lg overflow-hidden transition-all duration-300 ease-in-out ${scrolled ? 'rounded-b-2xl mt-2' : ''}
