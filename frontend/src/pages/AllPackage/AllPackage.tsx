        ...
        <div>
            ...
            <div className='bg-custom-black flex justify-between items-center p-3'>
                <div className='font-roboto text-white'>
                    <h1 className='text-lg'>Create your next super hit holiday</h1>
                    <p className='font-light text-[14px]'>Our destination experts can help curate an itinerary exactly for you. Free to connect over a call?</p>
                </div>
                <div>
